...
circom ./folding-schemes/src/frontend/circom/test_folder/full_flow_example.circom --r1cs --sym --wasm --prime bn128 --output ./folding-schemes/src/frontend/circom/test_folder/
